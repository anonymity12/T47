...
public class ParticleThread extends Thread{
    ...
    //线程的执行方法
    public void run(){
        father.ps.add(25, time);	//每次添加10个粒子；tt 每次看来是5 个啊
        while(flag){
            ...
            for(int i=0; i<count; i++){		//遍历粒子集合，修改其轨迹
                ...
                int tempy = (int)(particle.startY + 17.9*timeSpan*timeSpan + particle.vertical_v*timeSpan); // tt 位移 公式： 1/2 gt^2 + vt;;
