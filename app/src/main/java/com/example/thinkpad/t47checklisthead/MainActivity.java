        ...
        btnCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(phoneNo)) {
                    ...
                    if (isPermissionGranted(Manifest.permission.CALL_PHONE)) {
                        //tt: following code is add by me, for we are use 26, and he use 27, don't know why
                        //tt: anyway, one think is his this MainActivity code is old, but dependencies.gradle is newer
                        if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                            // if not granted so consider calling ActivityCompat#requestPermissions
