package com.example.thinkpad.t47checklisthead.activity;
...
import com.example.thinkpad.t47checklisthead.helper.MediaPlayerHelper;
import com.example.thinkpad.t47checklisthead.helper.MediaRecorderHelper;
import com.example.thinkpad.t47checklisthead.view.WaveView;


/**
 * Created by paul on 2018/5/27.
 * this one (SoundRecordActivity) is useful and have all function
 *  his mainActivity is useless see  https://github.com/burgessjp/MediaRecorderDemo
 */
...
public class SoundRecoderActivity extends AppCompatActivity implements View.OnClickListener, Runnable {
    ...
    private void initView() {
        mTypeFace = Typeface.createFromAsset(getAssets(), "AGENCYR.TTF");
