 ...
 * @Description 曲线图 的例子
 * @author rongtianzheng at 2018-05-01 02:53:53
 */
public class SplineChart01View extends DemoView {

    public static final int DATE_TYPE_X = 0;
    public static final int DATE_TYPE_Y = 1;
    public static final int DATE_TYPE_Z = 2;

    private static SplineData splineDataX = new SplineData("xData", null, Color.rgb(255, 165, 132), XEnum.DotStyle.HIDE);//orange
    private static SplineData splineDataY = new SplineData("yData", null, Color.rgb(0, 0, 255),XEnum.DotStyle.HIDE);//blue
    private static SplineData splineDataZ = new SplineData("zData", null, Color.rgb(255, 0, 255),XEnum.DotStyle.HIDE);//red pink
    ...
    private void initView() {
        ...
        chartData.add(splineDataY);
        chartData.add(splineDataZ);
