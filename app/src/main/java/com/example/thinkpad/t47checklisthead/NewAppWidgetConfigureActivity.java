...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.example.thinkpad.t47checklisthead.NewAppWidget";
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            //使用 Configuration Activity 应该始终返回结果
    ...
    public void onCreate(Bundle icicle) {
        ...
        //意思是 会通知App Widget Host 配置已取消,并且将不会添加App Widget.(Configuration Activity退出,不再创建App Widget)
